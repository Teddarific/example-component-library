...
import require$$0, { useCallback, useState, useEffect, useLayoutEffect, useRef, forwardRef, Fragment as Fragment$1, isValidElement, cloneElement, createElement, createContext, useContext, useMemo, useReducer, createRef } from "react";
const tailwind = "";
 ...
 */
var f$2 = require$$0, k = Symbol.for("react.element"), l$3 = Symbol.for("react.fragment"), m = Object.prototype.hasOwnProperty, n$3 = f$2.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, p$2 = { key: true, ref: true, __self: true, __source: true };
...
let s$5 = new o$4();
let l$2 = (e2, f2) => {
  s$5.isServer ? useEffect(e2, f2) : useLayoutEffect(e2, f2);
};
function s$4(e2) {
  let r2 = useRef(e2);
  return l$2(() => {
...
let o$2 = function(t2) {
  let e2 = s$4(t2);
  return require$$0.useCallback((...r2) => e2.current(...r2), [e2]);
};
function l$1() {
  let [e2, f2] = useState(s$5.isHandoffComplete);
  return e2 && s$5.isHandoffComplete === false && f2(false), useEffect(() => {
    e2 !== true && f2(true);
  }, [e2]), useEffect(() => s$5.handoff(), []), e2;
}
var o$1;
let I$2 = (o$1 = require$$0.useId) != null ? o$1 : function() {
  let n2 = l$1(), [e2, u2] = require$$0.useState(n2 ? () => s$5.nextId() : null);
  return l$2(() => {
...
function c$3(r2, t2 = {}, e$12, a2) {
  ...
  if (s2 === Fragment$1 && Object.keys(R(o3)).length > 0) {
    if (!isValidElement(l2) || Array.isArray(l2) && l2.length > 1)
...
`));
    ...
    return cloneElement(l2, Object.assign({}, N(l2.props, R(g(o3, ["ref"]))), p2, u2, w(l2.ref, u2.ref), y2));
  }
  return createElement(s2, Object.assign({}, g(o3, ["ref"]), s2 !== Fragment$1 && u2, s2 !== Fragment$1 && p2), l2);
}
function w(...r2) {
...
function c$1({ value: o3, children: r2 }) {
  return require$$0.createElement(n$2.Provider, { value: o3 }, r2);
}
...
function De$1(o3, l2) {
  var B;
  let s2 = useRef(null), R2 = y$1(l2, T((e2) => {
    s2.current = e2;
  })), C2 = useRef([]), r2 = useReducer(Me, { popoverState: 1, buttons: C2, button: null, buttonId: null, panel: null, panelId: null, beforePanelSentinel: createRef(), afterPanelSentinel: createRef() }), [{ popoverState: t2, button: a2, buttonId: v2, panel: f2, panelId: F2, beforePanelSentinel: T$2, afterPanelSentinel: d2 }, i2] = r2, p2 = n((B = s2.current) != null ? B : a2), P = useMemo(() => {
    if (!a2 || !f2)
      return false;
    for (let N2 of document.querySelectorAll("body > *"))
      if (Number(N2 == null ? void 0 : N2.contains(a2)) ^ Number(N2 == null ? void 0 : N2.contains(f2)))
        return true;
    let e2 = f$1(), n2 = e2.indexOf(a2), A2 = (n2 + e2.length - 1) % e2.length, g2 = (n2 + 1) % e2.length, G = e2[A2], Te = e2[g2];
    return !f2.contains(G) && !f2.contains(Te);
  }, [a2, f2]), S2 = s$4(v2), y2 = s$4(F2), x = useMemo(() => ({ buttonId: S2, panelId: y2, close: () => i2({ type: 1 }) }), [S2, y2, i2]), O2 = ve(), L$1 = O2 == null ? void 0 : O2.registerPopover, j2 = o$2(() => {
    var e2;
  ...
  useEffect(() => L$1 == null ? void 0 : L$1(x), [L$1, x]), E(p2 == null ? void 0 : p2.defaultView, "focus", (e2) => {
    var n2, A2, g2, G;
    t2 === 0 && (j2() || a2 && f2 && e2.target !== window && ((A2 = (n2 = T$2.current) == null ? void 0 : n2.contains) != null && A2.call(n2, e2.target) || (G = (g2 = d2.current) == null ? void 0 : g2.contains) != null && G.call(g2, e2.target) || i2({ type: 1 })));
  }, true), L([a2, f2], (e2, n2) => {
  ...
  let M2 = o$2((e2) => {
    ...
    n2 == null || n2.focus();
  }), u2 = useMemo(() => ({ close: M2, isPortalled: P }), [M2, P]), m2 = useMemo(() => ({ open: t2 === 0, close: M2 }), [t2, M2]), E$1 = o3, c2 = { ref: R2 };
  return require$$0.createElement(Z.Provider, { value: null }, require$$0.createElement(le.Provider, { value: r2 }, require$$0.createElement(ae.Provider, { value: u2 }, require$$0.createElement(c$1, { value: u$1(t2, { [0]: d$1.Open, [1]: d$1.Closed }) }, X({ ourProps: c2, theirProps: E$1, slot: m2, defaultTag: Be, name: "Popover" })))));
}
let he = "button";
function He$1(o$12, l2) {
  let s$12 = I$2(), { id: R2 = `headlessui-popover-button-${s$12}`, ...C2 } = o$12, [r$12, t2] = Q("Popover.Button"), { isPortalled: a2 } = pe("Popover.Button"), v2 = useRef(null), f2 = `headlessui-focus-sentinel-${I$2()}`, F2 = ve(), T2 = F2 == null ? void 0 : F2.closeOthers, i2 = Le() !== null;
  useEffect(() => {
    if (!i2)
  ...
  let [p$12] = useState(() => Symbol()), P = y$1(v2, l2, i2 ? null : (e2) => {
    if (e2)
  ...
  }), M$1 = r$12.popoverState === 0, u2 = useMemo(() => ({ open: M$1 }), [M$1]), m2 = s$3(o$12, v2), E2 = i2 ? { ref: S2, type: m2, onKeyDown: x, onClick: L2 } : { ref: P, id: r$12.buttonId, type: m2, "aria-expanded": o$12.disabled ? void 0 : r$12.popoverState === 0, "aria-controls": r$12.panel ? r$12.panelId : void 0, onKeyDown: x, onKeyUp: O$1, onClick: L2, onMouseDown: j2 }, c2 = n$1(), B = o$2(() => {
    let e2 = r$12.panel;
    if (!e2)
      return;
    function n2() {
  ...
  return require$$0.createElement(require$$0.Fragment, null, X({ ourProps: E2, theirProps: C2, slot: u2, defaultTag: he, name: "Popover.Button" }), M$1 && !i2 && a2 && require$$0.createElement(c$2, { id: f2, features: p.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: B }));
}
let Ge = "div", _e = S$1.RenderStrategy | S$1.Static;
function ke(o3, l2) {
  let s2 = I$2(), { id: R2 = `headlessui-popover-overlay-${s2}`, ...C$1 } = o3, [{ popoverState: r$12 }, t2] = Q("Popover.Overlay"), a2 = y$1(l2), v2 = C(), f2 = (() => v2 !== null ? (v2 & d$1.Open) === d$1.Open : r$12 === 0)(), F2 = o$2((i2) => {
    if (r(i2.currentTarget))
      return i2.preventDefault();
    t2({ type: 1 });
  }), T2 = useMemo(() => ({ open: r$12 === 0 }), [r$12]);
  return X({ ourProps: { ref: a2, id: R2, "aria-hidden": true, onClick: F2 }, theirProps: C$1, slot: T2, defaultTag: Ge, features: _e, visible: f2, name: "Popover.Overlay" });
}
let we = "div", Ne$1 = S$1.RenderStrategy | S$1.Static;
function Ue(o$12, l2) {
  let s$12 = I$2(), { id: R2 = `headlessui-popover-panel-${s$12}`, focus: C$1 = false, ...r2 } = o$12, [t2, a2] = Q("Popover.Panel"), { close: v2, isPortalled: f2 } = pe("Popover.Panel"), F2 = `headlessui-focus-sentinel-before-${I$2()}`, T2 = `headlessui-focus-sentinel-after-${I$2()}`, d2 = useRef(null), i2 = y$1(d2, l2, (u2) => {
    a2({ type: 4, panel: u2 });
  }), p$12 = n(d2);
  l$2(() => (a2({ type: 5, panelId: R2 }), () => {
    a2({ type: 5, panelId: null });
  }), [R2, a2]);
  let P = C(), S2 = (() => P !== null ? (P & d$1.Open) === d$1.Open : t2.popoverState === 0)(), y2 = o$2((u2) => {
    var m2;
    switch (u2.key) {
      case o2.Escape:
  ...
  }, [t2.popoverState, o$12.unmount, o$12.static, a2]), useEffect(() => {
    if (!C$1 || t2.popoverState !== 0 || !d2.current)
      return;
    let u2 = p$12 == null ? void 0 : p$12.activeElement;
    d2.current.contains(u2) || O(d2.current, M.First);
  }, [C$1, d2, t2.popoverState]);
  let x = useMemo(() => ({ open: t2.popoverState === 0, close: v2 }), [t2, v2]), O$1 = { ref: i2, id: R2, onKeyDown: y2, onBlur: C$1 && t2.popoverState === 0 ? (u2) => {
    var E2, c2, B, e2, n2;
    let m2 = u2.relatedTarget;
    m2 && d2.current && ((E2 = d2.current) != null && E2.contains(m2) || (a2({ type: 1 }), ((B = (c2 = t2.beforePanelSentinel.current) == null ? void 0 : c2.contains) != null && B.call(c2, m2) || (n2 = (e2 = t2.afterPanelSentinel.current) == null ? void 0 : e2.contains) != null && n2.call(e2, m2)) && m2.focus({ preventScroll: true })));
    ...
    function m2() {
      u$1(L2.current, { [s.Forwards]: () => {
        ...
        if (!t2.button)
          return;
        let E2 = f$1(), c2 = E2.indexOf(t2.button), B = E2.slice(0, c2 + 1), n2 = [...E2.slice(c2 + 1), ...B];
  ...
  return require$$0.createElement(Z.Provider, { value: R2 }, S2 && f2 && require$$0.createElement(c$2, { id: F2, ref: t2.beforePanelSentinel, features: p.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: j2 }), X({ ourProps: O$1, theirProps: r2, slot: x, defaultTag: we, features: Ne$1, visible: S2, name: "Popover.Panel" }), S2 && f2 && require$$0.createElement(c$2, { id: T2, ref: t2.afterPanelSentinel, features: p.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: M$1 }));
}
let Ke = "div";
function We(o3, l2) {
  let s2 = useRef(null), R2 = y$1(s2, l2), [C2, r2] = useState([]), t2 = o$2((p2) => {
    r2((P) => {
      let S2 = P.indexOf(p2);
      if (S2 !== -1) {
        let y2 = P.slice();
  ...
  }), a2 = o$2((p2) => (r2((P) => [...P, p2]), () => t2(p2))), v2 = o$2(() => {
    var S2;
    let p2 = e$1(s2);
    if (!p2)
      return false;
    let P = p2.activeElement;
    return (S2 = s2.current) != null && S2.contains(P) ? true : C2.some((y2) => {
      var x, O2;
      return ((x = p2.getElementById(y2.buttonId.current)) == null ? void 0 : x.contains(P)) || ((O2 = p2.getElementById(y2.panelId.current)) == null ? void 0 : O2.contains(P));
    });
  }), f2 = o$2((p2) => {
    for (let P of C2)
      P.buttonId.current !== p2 && P.close();
  }), F2 = useMemo(() => ({ registerPopover: a2, unregisterPopover: t2, isFocusWithinPopoverGroup: v2, closeOthers: f2 }), [a2, t2, v2, f2]), T2 = useMemo(() => ({}), []), d2 = o3, i2 = { ref: R2 };
  return require$$0.createElement(se.Provider, { value: F2 }, X({ ourProps: i2, theirProps: d2, slot: T2, defaultTag: Ke, name: "Popover.Group" }));
}
let je = D$1(De$1), Ve = D$1(He$1), $e = D$1(ke), Je = D$1(Ue), Xe = D$1(We), Lt = Object.assign(je, { Button: Ve, Overlay: $e, Panel: Je, Group: Xe });
function c(a2 = 0) {
  let [l2, r2] = useState(a2), t2 = f(), o3 = useCallback((e2) => {
...
function ne(n2, t2) {
  let r2 = s$4(n2), o3 = useRef([]), y2 = f(), N2 = p$1(), p2 = o$2((s2, e2 = j.Hidden) => {
  ...
  }), m2 = useRef([]), c2 = useRef(Promise.resolve()), u2 = useRef({ enter: [], leave: [], idle: [] }), h2 = o$2((s2, e2, a2) => {
  ...
  return useMemo(() => ({ children: o3, register: x, unregister: p2, onStart: h2, onStop: v2, wait: c2, chains: u2 }), [x, p2, o3, h2, v2, u2, c2]);
}
function Se() {
}
...
function ye(n2, t2) {
  let { beforeEnter: r2, afterEnter: o3, beforeLeave: y2, afterLeave: N2, enter: p2, enterFrom: x, enterTo: m2, entered: c$22, leave: u2, leaveFrom: h2, leaveTo: v2, ...s2 } = n2, e$12 = useRef(null), a2 = y$1(e$12, t2), i2 = s2.unmount ? j.Unmount : j.Hidden, { show: l2, appear: T2, initial: se2 } = Ee(), [g2, M2] = useState(l2 ? "visible" : "hidden"), z = be(), { register: F2, unregister: L2 } = z, U = useRef(null);
  useEffect(() => F2(e$12), [F2, e$12]), useEffect(() => {
  ...
  let j$1 = s$4({ enter: S(p2), enterFrom: S(x), enterTo: S(m2), entered: S(c$22), leave: S(u2), leaveFrom: S(h2), leaveTo: S(v2) }), w2 = Pe({ beforeEnter: r2, afterEnter: o3, beforeLeave: y2, afterLeave: N2 }), k2 = l$1();
  useEffect(() => {
    if (k2 && g2 === "visible" && e$12.current === null)
      throw new Error("Did you forget to passthrough the `ref` to the actual DOM node?");
  }, [e$12, g2, k2]);
  let G = se2 && !T2, ae2 = (() => !k2 || G || U.current === l2 ? "idle" : l2 ? "enter" : "leave")(), H2 = c(0), le2 = o$2((C2) => u$1(C2, { enter: () => {
  ...
  D({ container: e$12, classes: j$1, direction: ae2, onStart: s$4((C2) => {
    ...
    G && (i2 === j.Hidden ? U.current = null : U.current = l2);
  }, [l2, G, g2]);
  let B = s2, Te = { ref: a2 };
  return T2 && l2 && (B = { ...B, className: e(s2.className, ...j$1.current.enter, ...j$1.current.enterFrom) }), require$$0.createElement(I.Provider, { value: O2 }, require$$0.createElement(c$1, { value: u$1(g2, { ["visible"]: d$1.Open, ["hidden"]: d$1.Closed }) | H2.flags }, X({ ourProps: Te, theirProps: B, defaultTag: Re, features: ie, visible: g2 === "visible", name: "Transition.Child" })));
}
function Ne(n2, t2) {
  let { show: r2, appear: o3 = false, unmount: y2, ...N2 } = n2, p2 = useRef(null), x = y$1(p2, t2);
  l$1();
  let m2 = C();
  if (r2 === void 0 && m2 !== null && (r2 = (m2 & d$1.Open) === d$1.Open), ![true, false].includes(r2))
    throw new Error("A <Transition /> is used but it is missing a `show={true | false}` prop.");
  let [c2, u2] = useState(r2 ? "visible" : "hidden"), h2 = ne(() => {
    u2("hidden");
  }), [v2, s2] = useState(true), e2 = useRef([r2]);
  l$2(() => {
  ...
  let i2 = { unmount: y2 };
  return require$$0.createElement(I.Provider, { value: h2 }, require$$0.createElement(A.Provider, { value: a2 }, X({ ourProps: { ...i2, as: Fragment$1, children: require$$0.createElement(oe, { ref: x, ...i2, ...N2 }) }, theirProps: {}, defaultTag: Fragment$1, features: ie, visible: c2 === "visible", name: "Transition" })));
}
function He(n2, t2) {
  let r2 = useContext(A) !== null, o3 = C() !== null;
  return require$$0.createElement(require$$0.Fragment, null, !r2 && o3 ? require$$0.createElement(q, { ref: t2, ...n2 }) : require$$0.createElement(oe, { ref: t2, ...n2 }));
}
