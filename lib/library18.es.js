...
function l$1() {
  ...
  return (
    ...
    useEffect(() => s$5.handoff(), []),
    e2
  )
}
var o$1
let I$2 =
  (o$1 = require$$0.useId) != null
    ? o$1
    : function () {
        let n2 = l$1(),
          [e2, u2] = require$$0.useState(n2 ? () => s$5.nextId() : null)
        return (
          l$2(() => {
...
function m(r2, t2 = {}, e$12, a2) {
  ...
  if (s2 === Fragment$1 && Object.keys(P(o3)).length > 0) {
...
function De$1(o3, l2) {
  ...
  useEffect(() => (L2 == null ? void 0 : L2(x)), [L2, x]),
    E(
...
function Ne(n2, t2) {
  let {
    ...
    [g2, M] = useState(l2 ? 'visible' : 'hidden'),
    z = Se(),
    { register: F2, unregister: L2 } = z,
    U = useRef(null)
  useEffect(() => F2(e$12), [F2, e$12]),
    useEffect(() => {
  ...
  let G = se2 && !T2,
    ae2 = (() =>
      !k2 || G || U.current === l2 ? 'idle' : l2 ? 'enter' : 'leave')(),
    H2 = b(0),
    le2 = o$2((C2) =>
      u$1(C2, {
        enter: () => {
...
function He(n2, t2) {
  ...
  let [c2, u2] = useState(r2 ? 'visible' : 'hidden'),
    h2 = ne(() => {
      u2('hidden')
    }),
    [v2, s2] = useState(true),
    ...
    require$$0.createElement(
      ...
      D$1({
        ourProps: {
          ...i2,
          as: Fragment$1,
          children: require$$0.createElement(oe, { ref: x, ...i2, ...N2 }),
        },
        theirProps: {},
        defaultTag: Fragment$1,
        features: ie,
        visible: c2 === 'visible',
        name: 'Transition',
      })
...
function De(n2, t2) {
  ...
  return require$$0.createElement(
    ...
    null,
    !r2 && o3
      ? require$$0.createElement(q, { ref: t2, ...n2 })
      : require$$0.createElement(oe, { ref: t2, ...n2 })
  )
}
let q = L(He),
  oe = L(Ne),
