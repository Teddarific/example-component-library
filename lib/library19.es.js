...
function l$1() {
  ...
  return (
    ...
    react.useEffect(() => s$5.handoff(), []),
    e2
  )
}
var o$1
let I$2 =
  (o$1 = react.useId) != null
    ? o$1
    : function () {
        let n2 = l$1(),
          [e2, u2] = react.useState(n2 ? () => s$5.nextId() : null)
        return (
          l$2(() => {
...
`)
  ...
  return react.createElement(
    ...
    Object.assign(
      {},
      g(o3, ['ref']),
      s2 !== react.Fragment && u2,
      s2 !== react.Fragment && p2
    ),
    l2
  )
}
...
function D$1(r2) {
  var t2
  return Object.assign(react.forwardRef(r2), {
...
function De$1(o3, l2) {
  ...
  react.useEffect(() => (L$12 == null ? void 0 : L$12(x2)), [L$12, x2]),
    E(
  ...
  let M2 = o$2((e2) => {
    ...
    u2 = react.useMemo(() => ({ close: M2, isPortalled: P2 }), [M2, P2]),
    m2 = react.useMemo(() => ({ open: t2 === 0, close: M2 }), [t2, M2]),
    E$12 = o3,
    c2 = { ref: R2 }
  return react.createElement(
    Z.Provider,
...
function He$1(o$12, l2) {
  ...
  let [p$12] = react.useState(() => Symbol()),
    P2 = y$1(
      v2,
      l2,
      i2
    ...
    u2 = react.useMemo(() => ({ open: M$12 }), [M$12]),
    m2 = s$3(o$12, v2),
    E2 = i2
...
function c(a2 = 0) {
  let [l2, r2] = react.useState(a2),
    t2 = f(),
    o3 = react.useCallback(
      (e2) => {
        t2.current && r2((u2) => u2 | e2)
      },
      [l2, t2]
    ),
    m2 = react.useCallback((e2) => Boolean(l2 & e2), [l2]),
    s2 = react.useCallback(
      (e2) => {
        t2.current && r2((u2) => u2 & ~e2)
      },
      [r2, t2]
    ),
    g2 = react.useCallback(
      (e2) => {
        t2.current && r2((u2) => u2 ^ e2)
      },
      [r2]
...
function ne(n2, t2) {
  let r2 = s$4(n2),
    ...
    m2 = react.useRef([]),
    c2 = react.useRef(Promise.resolve()),
    u2 = react.useRef({ enter: [], leave: [], idle: [] }),
    h2 = o$2((s2, e2, a2) => {
      m2.current.splice(0),
        t2 &&
...
function ye(n2, t2) {
  let {
    ...
    e$12 = react.useRef(null),
    a2 = y$1(e$12, t2),
    i2 = s2.unmount ? j.Unmount : j.Hidden,
    { show: l2, appear: T2, initial: se2 } = Ee(),
    [g2, M2] = react.useState(l2 ? 'visible' : 'hidden'),
    z2 = be(),
    { register: F2, unregister: L2 } = z2,
    U2 = react.useRef(null)
  react.useEffect(() => F2(e$12), [F2, e$12]),
    react.useEffect(() => {
...
function Ne(n2, t2) {
  ...
  let [c2, u2] = react.useState(r2 ? 'visible' : 'hidden'),
    h2 = ne(() => {
      u2('hidden')
    }),
    [v2, s2] = react.useState(true),
    e2 = react.useRef([r2])
  l$2(() => {
    v2 !== false &&
    ...
    react.createElement(
      ...
      X({
        ourProps: {
          ...i2,
          as: react.Fragment,
          children: react.createElement(oe, { ref: x2, ...i2, ...N2 }),
        },
        theirProps: {},
...
function He(n2, t2) {
  let r2 = react.useContext(A) !== null,
    o3 = C() !== null
  return react.createElement(
    react.Fragment,
    null,
    !r2 && o3
      ? react.createElement(q, { ref: t2, ...n2 })
      : react.createElement(oe, { ref: t2, ...n2 })
  )
}
let q = D$1(Ne),
  oe = D$1(ye),
