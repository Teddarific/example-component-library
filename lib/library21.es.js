...
function M$1(a2, b, e2) {
  var d2,
    ...
    h2 = null
  if (null != b)
    for (d2 in (void 0 !== b.ref && (h2 = b.ref),
...
function R$1(a2, b, e2, d2, c2) {
  ...
  if (h2)
    return (
      ...
      I$3(c2)
        ? ((e2 = ''),
          null != a2 && (e2 = a2.replace(P, '$&/') + '/'),
          R$1(c2, b, e2, '', function (a3) {
            return a3
          }))
        : null != c2 &&
          (O$1(c2) &&
  ...
  if (null != b) {
    ...
    for (f2 in b)
      J.call(b, f2) &&
        ...
        (d2[f2] = void 0 === b[f2] && void 0 !== g2 ? g2[f2] : b[f2])
  }
...
function q$1(c2, a2, g2) {
  ...
  for (b in a2) m.call(a2, b) && !p$2.hasOwnProperty(b) && (d2[b] = a2[b])
  if (c2 && c2.defaultProps)
    for (b in ((a2 = c2.defaultProps), a2)) void 0 === d2[b] && (d2[b] = a2[b])
  return {
    $$typeof: k,
    type: c2,
    key: e2,
...
let l$2 = (e2, f2) => {
  s$5.isServer
    ? reactExports.useEffect(e2, f2)
    : reactExports.useLayoutEffect(e2, f2)
}
function s$4(e2) {
...
let I$2 =
  (o$1 = d$4.useId) != null
    ...
    : function () {
        let n2 = l$1(),
          [e2, u2] = d$4.useState(n2 ? () => s$5.nextId() : null)
        return (
          l$2(() => {
...
var M = ((n2) => (
  ...
  F$1 = ((t2) => (
    (t2[(t2.Previous = -1)] = 'Previous'), (t2[(t2.Next = 1)] = 'Next'), t2
  ))(F$1 || {})
function f$1(e2 = document.body) {
  return e2 == null
    ? []
    : Array.from(e2.querySelectorAll(c$4)).sort((r2, t2) =>
        Math.sign(
          (r2.tabIndex || Number.MAX_SAFE_INTEGER) -
            (t2.tabIndex || Number.MAX_SAFE_INTEGER)
        )
      )
}
var T$1 = ((t2) => (
  (t2[(t2.Strict = 0)] = 'Strict'), (t2[(t2.Loose = 1)] = 'Loose'), t2
))(T$1 || {})
function h(e2, r2 = 0) {
  var t2
  return e2 === ((t2 = e$1(e2)) == null ? void 0 : t2.body)
    ? false
    : u$1(r2, {
        [0]() {
...
var w$1 = ((t2) => (
  (t2[(t2.Keyboard = 0)] = 'Keyboard'), (t2[(t2.Mouse = 1)] = 'Mouse'), t2
))(w$1 || {})
...
function H(e2) {
  var r2, t2
  return (t2 =
    (r2 = e2 == null ? void 0 : e2.matches) == null
      ? void 0
      : r2.call(e2, S$2)) != null
    ? t2
    : false
...
function O(
  e2,
  r2,
  { sorted: t2 = true, relativeTo: l2 = null, skipElements: o3 = [] } = {}
) {
  let i2 = Array.isArray(e2)
      ? e2.length > 0
        ...
        : document
      : e2.ownerDocument,
    n2 = Array.isArray(e2) ? (t2 ? I$1(e2) : e2) : f$1(e2)
  o3.length > 0 && n2.length > 1 && (n2 = n2.filter((s2) => !o3.includes(s2))),
...
function L(m2, E2, c2 = true) {
  ...
  function f2(e2, o3) {
    ...
    if (n2 !== null && n2.getRootNode().contains(n2)) {
      ...
      return (
        !h(n2, T$1.Loose) && n2.tabIndex !== -1 && e2.preventDefault(),
        E2(e2, n2)
      )
    }
  }
...
function X({
  ...
  let o3 = N(t2, r2)
  if (n2) return c$3(o3, e2, a2, f2)
  let u2 = s2 != null ? s2 : 0
  if (u2 & 2) {
    let { static: l2 = false, ...p2 } = o3
    if (l2) return c$3(p2, e2, a2, f2)
  }
  if (u2 & 1) {
    ...
    return u$1(l2 ? 0 : 1, {
      ...
      [1]() {
        return c$3(
          { ...p2, hidden: true, style: { display: 'none' } },
          e2,
          a2,
          f2
        )
...
function c$3(r2, t2 = {}, e$12, a2) {
  let {
    ...
    u2 = r2.ref !== void 0 ? { [f2]: r2.ref } : {},
    l2 = typeof n2 == 'function' ? n2(t2) : n2
  'className' in o3 &&
    o3.className &&
  ...
  if (s2 === reactExports.Fragment && Object.keys(R(o3)).length > 0) {
    if (
      !reactExports.isValidElement(l2) ||
      (Array.isArray(l2) && l2.length > 1)
    )
      throw new Error(
        [
...
`)
    ...
    let i2 = l2.props,
      m2 =
        typeof (i2 == null ? void 0 : i2.className) == 'function'
          ? (...d2) =>
              e(i2 == null ? void 0 : i2.className(...d2), o3.className)
          : e(i2 == null ? void 0 : i2.className, o3.className),
      y2 = m2 ? { className: m2 } : {}
    return reactExports.cloneElement(
      l2,
      Object.assign(
        {},
        N(l2.props, R(g(o3, ['ref']))),
        p2,
        u2,
        w(l2.ref, u2.ref),
        y2
  ...
  return reactExports.createElement(
    ...
    Object.assign(
      {},
      g(o3, ['ref']),
      s2 !== reactExports.Fragment && u2,
      s2 !== reactExports.Fragment && p2
    ),
    l2
  )
}
...
function D$1(r2) {
  var t2
  return Object.assign(reactExports.forwardRef(r2), {
...
function De$1(o3, l2) {
  var B2
  let s2 = reactExports.useRef(null),
    R2 = y$1(
      l2,
      T((e2) => {
        s2.current = e2
    ...
    C2 = reactExports.useRef([]),
    r2 = reactExports.useReducer(Me, {
      popoverState: 1,
      buttons: C2,
      button: null,
      buttonId: null,
      panel: null,
      panelId: null,
      beforePanelSentinel: reactExports.createRef(),
      afterPanelSentinel: reactExports.createRef(),
    }),
    [
      {
        popoverState: t2,
        ...
        panel: f2,
        panelId: F2,
        beforePanelSentinel: T$22,
        afterPanelSentinel: d2,
      },
      i2,
    ] = r2,
    p2 = n((B2 = s2.current) != null ? B2 : a2),
    ...
    S2 = s$4(v2),
    y2 = s$4(F2),
    x2 = reactExports.useMemo(
      () => ({ buttonId: S2, panelId: y2, close: () => i2({ type: 1 }) }),
      [S2, y2, i2]
    ),
    O2 = ve(),
    L$12 = O2 == null ? void 0 : O2.registerPopover,
    j2 = o$2(() => {
      var e2
  ...
  reactExports.useEffect(() => (L$12 == null ? void 0 : L$12(x2)), [L$12, x2]),
    E(
        ...
        t2 === 0 &&
          (j2() ||
            (a2 &&
              f2 &&
              e2.target !== window &&
              (((A2 = (n2 = T$22.current) == null ? void 0 : n2.contains) !=
                null &&
                A2.call(n2, e2.target)) ||
                ((G2 = (g2 = d2.current) == null ? void 0 : g2.contains) !=
                  null &&
                  G2.call(g2, e2.target)) ||
                i2({ type: 1 }))))
      },
      true
    ),
    L(
      ...
      (e2, n2) => {
        i2({ type: 1 }),
          h(n2, T$1.Loose) || (e2.preventDefault(), a2 == null || a2.focus())
      },
      t2 === 0
    )
  let M2 = o$2((e2) => {
    ...
    u2 = reactExports.useMemo(() => ({ close: M2, isPortalled: P2 }), [M2, P2]),
    m2 = reactExports.useMemo(() => ({ open: t2 === 0, close: M2 }), [t2, M2]),
    E$12 = o3,
    c2 = { ref: R2 }
  return d$4.createElement(
    Z.Provider,
    { value: null },
    d$4.createElement(
      le.Provider,
...
function He$1(o$12, l2) {
  let s$12 = I$2(),
    { id: R2 = `headlessui-popover-button-${s$12}`, ...C2 } = o$12,
    [r$12, t2] = Q('Popover.Button'),
    { isPortalled: a2 } = pe('Popover.Button'),
    v2 = reactExports.useRef(null),
  ...
  reactExports.useEffect(() => {
    if (!i2)
      return (
        t2({ type: 3, buttonId: R2 }),
        () => {
          t2({ type: 3, buttonId: null })
        }
      )
  }, [i2, R2, t2])
  let [p$12] = reactExports.useState(() => Symbol()),
    P2 = y$1(
      v2,
      l2,
      i2
    ...
    M$12 = r$12.popoverState === 0,
    u2 = reactExports.useMemo(() => ({ open: M$12 }), [M$12]),
    m2 = s$3(o$12, v2),
    E2 = i2
      ? { ref: S2, type: m2, onKeyDown: x2, onClick: L2 }
      : {
          ref: P2,
          id: r$12.buttonId,
          type: m2,
    ...
    B2 = o$2(() => {
      ...
      function n2() {
        u$1(c2.current, {
          [s.Forwards]: () => O(e2, M.First),
          [s.Backwards]: () => O(e2, M.Last),
        }) === N$1.Error &&
          O(
            f$1().filter((g2) => g2.dataset.headlessuiFocusGuard !== 'true'),
            u$1(c2.current, {
              [s.Forwards]: M.Next,
              [s.Backwards]: M.Previous,
            }),
...
let Ge = 'div',
  _e = S$1.RenderStrategy | S$1.Static
function ke(o3, l2) {
  let s2 = I$2(),
    { id: R2 = `headlessui-popover-overlay-${s2}`, ...C$12 } = o3,
  ...
  return X({
    ourProps: { ref: a2, id: R2, 'aria-hidden': true, onClick: F2 },
    theirProps: C$12,
    slot: T2,
    defaultTag: Ge,
    features: _e,
...
let we = 'div',
  Ne$1 = S$1.RenderStrategy | S$1.Static
function Ue(o$12, l2) {
  let s$12 = I$2(),
    {
      id: R2 = `headlessui-popover-panel-${s$12}`,
      focus: C$12 = false,
      ...r2
    } = o$12,
    ...
    v2 = o$2(() => {
      ...
      return (S2 = s2.current) != null && S2.contains(P2)
        ...
        : C2.some((y2) => {
            var x2, O2
            return (
              ((x2 = p2.getElementById(y2.buttonId.current)) == null
                ? void 0
                : x2.contains(P2)) ||
...
function c(a2 = 0) {
  let [l2, r2] = reactExports.useState(a2),
    t2 = f(),
    o3 = reactExports.useCallback(
      (e2) => {
        t2.current && r2((u2) => u2 | e2)
      },
      [l2, t2]
    ),
    m2 = reactExports.useCallback((e2) => Boolean(l2 & e2), [l2]),
...
var Ce = ((r2) => ((r2.Visible = 'visible'), (r2.Hidden = 'hidden'), r2))(
  Ce || {}
)
function Ee() {
...
function ne(n2, t2) {
  let r2 = s$4(n2),
    o3 = reactExports.useRef([]),
    y2 = f(),
    N2 = p$1(),
    p2 = o$2((s2, e2 = j.Hidden) => {
    ...
    m2 = reactExports.useRef([]),
    c2 = reactExports.useRef(Promise.resolve()),
    u2 = reactExports.useRef({ enter: [], leave: [], idle: [] }),
    h2 = o$2((s2, e2, a2) => {
      m2.current.splice(0),
        t2 &&
...
function re(n2) {
  var r2
  let t2 = {}
  for (let o3 of xe) t2[o3] = (r2 = n2[o3]) != null ? r2 : Se
  return t2
}
function Pe(n2) {
...
function ye(n2, t2) {
  let {
    ...
    e$12 = reactExports.useRef(null),
    a2 = y$1(e$12, t2),
    i2 = s2.unmount ? j.Unmount : j.Hidden,
    { show: l2, appear: T2, initial: se2 } = Ee(),
    [g2, M2] = reactExports.useState(l2 ? 'visible' : 'hidden'),
    z2 = be(),
    { register: F2, unregister: L2 } = z2,
    U2 = reactExports.useRef(null)
  reactExports.useEffect(() => F2(e$12), [F2, e$12]),
    reactExports.useEffect(() => {
  ...
  let G2 = se2 && !T2,
    ae2 = (() =>
      !k2 || G2 || U2.current === l2 ? 'idle' : l2 ? 'enter' : 'leave')(),
    H2 = c(0),
    le2 = o$2((C2) =>
      u$1(C2, {
        enter: () => {
  ...
  D({
    ...
    onStop: s$4((C2) => {
      O2.onStop(e$12, C2, ue),
        C2 === 'leave' && !_(O2) && (M2('hidden'), L2(e$12))
    }),
  }),
    reactExports.useEffect(() => {
...
function Ne(n2, t2) {
  ...
  let [c2, u2] = reactExports.useState(r2 ? 'visible' : 'hidden'),
    h2 = ne(() => {
      u2('hidden')
    }),
    [v2, s2] = reactExports.useState(true),
    e2 = reactExports.useRef([r2])
  l$2(() => {
    v2 !== false &&
      e2.current[e2.current.length - 1] !== r2 &&
      (e2.current.push(r2), s2(false))
  }, [e2, r2])
  let a2 = reactExports.useMemo(
    () => ({ show: r2, appear: o3, initial: v2 }),
    [r2, o3, v2]
  )
  reactExports.useEffect(() => {
    if (r2) u2('visible')
    ...
    d$4.createElement(
      ...
      X({
        ourProps: {
          ...
          children: d$4.createElement(oe, { ref: x2, ...i2, ...N2 }),
        },
        theirProps: {},
...
function He(n2, t2) {
  let r2 = reactExports.useContext(A) !== null,
    o3 = C() !== null
  return d$4.createElement(
    d$4.Fragment,
    null,
    !r2 && o3
      ? d$4.createElement(q, { ref: t2, ...n2 })
      : d$4.createElement(oe, { ref: t2, ...n2 })
  )
}
let q = D$1(Ne),
  oe = D$1(ye),
  De = D$1(He),
  tt = Object.assign(q, { Child: De, Root: q })
