...
const d$4 = /* @__PURE__ */ getDefaultExportFromCjs(reactExports);
/**
 * @license React
...
function CopyTextButton({
  ...
  const onCopied = reactExports.useCallback(() => {
    setCopied(true);
    setTimeout(() => {
      setCopied(false);
    }, 1500);
...
let o$2 = function(t2) {
  let e2 = s$4(t2);
  return d$4.useCallback((...r2) => e2.current(...r2), [e2]);
};
function l$1() {
...
var o$1;
let I$2 = (o$1 = d$4.useId) != null ? o$1 : function() {
  let n2 = l$1(), [e2, u2] = d$4.useState(n2 ? () => s$5.nextId() : null);
  return l$2(() => {
...
function c$1({ value: o3, children: r2 }) {
  return d$4.createElement(n$2.Provider, { value: o3 }, r2);
}
...
} }, le = reactExports.createContext(null);
le.displayName = "PopoverContext";
function Q(o3) {
  let l2 = reactExports.useContext(le);
  if (l2 === null) {
...
let ae = reactExports.createContext(null);
ae.displayName = "PopoverAPIContext";
function pe(o3) {
  let l2 = reactExports.useContext(ae);
  if (l2 === null) {
    let s2 = new Error(`<${o3} /> is missing a parent <Popover /> component.`);
...
function De$1(o3, l2) {
  var B2;
  let s2 = reactExports.useRef(null), R2 = y$1(l2, T((e2) => {
    s2.current = e2;
  })), C2 = reactExports.useRef([]), r2 = reactExports.useReducer(Me, { popoverState: 1, buttons: C2, button: null, buttonId: null, panel: null, panelId: null, beforePanelSentinel: reactExports.createRef(), afterPanelSentinel: reactExports.createRef() }), [{ popoverState: t2, button: a2, buttonId: v2, panel: f2, panelId: F2, beforePanelSentinel: T$22, afterPanelSentinel: d2 }, i2] = r2, p2 = n((B2 = s2.current) != null ? B2 : a2), P2 = reactExports.useMemo(() => {
    if (!a2 || !f2)
      return false;
  ...
  }, [a2, f2]), S2 = s$4(v2), y2 = s$4(F2), x2 = reactExports.useMemo(() => ({ buttonId: S2, panelId: y2, close: () => i2({ type: 1 }) }), [S2, y2, i2]), O2 = ve(), L$12 = O2 == null ? void 0 : O2.registerPopover, j2 = o$2(() => {
    var e2;
  ...
  reactExports.useEffect(() => L$12 == null ? void 0 : L$12(x2), [L$12, x2]), E(p2 == null ? void 0 : p2.defaultView, "focus", (e2) => {
    var n2, A2, g2, G2;
  ...
  let M2 = o$2((e2) => {
    ...
    n2 == null || n2.focus();
  }), u2 = reactExports.useMemo(() => ({ close: M2, isPortalled: P2 }), [M2, P2]), m2 = reactExports.useMemo(() => ({ open: t2 === 0, close: M2 }), [t2, M2]), E$12 = o3, c2 = { ref: R2 };
  return d$4.createElement(Z.Provider, { value: null }, d$4.createElement(le.Provider, { value: r2 }, d$4.createElement(ae.Provider, { value: u2 }, d$4.createElement(c$1, { value: u$1(t2, { [0]: d$1.Open, [1]: d$1.Closed }) }, X({ ourProps: c2, theirProps: E$12, slot: m2, defaultTag: Be, name: "Popover" })))));
}
let he = "button";
function He$1(o$12, l2) {
  let s$12 = I$2(), { id: R2 = `headlessui-popover-button-${s$12}`, ...C2 } = o$12, [r$12, t2] = Q("Popover.Button"), { isPortalled: a2 } = pe("Popover.Button"), v2 = reactExports.useRef(null), f2 = `headlessui-focus-sentinel-${I$2()}`, F2 = ve(), T2 = F2 == null ? void 0 : F2.closeOthers, i2 = Le() !== null;
  reactExports.useEffect(() => {
    if (!i2)
  ...
  let [p$12] = reactExports.useState(() => Symbol()), P2 = y$1(v2, l2, i2 ? null : (e2) => {
    if (e2)
  ...
  return d$4.createElement(d$4.Fragment, null, X({ ourProps: E2, theirProps: C2, slot: u2, defaultTag: he, name: "Popover.Button" }), M$12 && !i2 && a2 && d$4.createElement(c$2, { id: f2, features: p.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: B2 }));
}
...
function ke(o3, l2) {
  let s2 = I$2(), { id: R2 = `headlessui-popover-overlay-${s2}`, ...C$12 } = o3, [{ popoverState: r$12 }, t2] = Q("Popover.Overlay"), a2 = y$1(l2), v2 = C(), f2 = (() => v2 !== null ? (v2 & d$1.Open) === d$1.Open : r$12 === 0)(), F2 = o$2((i2) => {
    ...
    t2({ type: 1 });
  }), T2 = reactExports.useMemo(() => ({ open: r$12 === 0 }), [r$12]);
...
function Ue(o$12, l2) {
  let s$12 = I$2(), { id: R2 = `headlessui-popover-panel-${s$12}`, focus: C$12 = false, ...r2 } = o$12, [t2, a2] = Q("Popover.Panel"), { close: v2, isPortalled: f2 } = pe("Popover.Panel"), F2 = `headlessui-focus-sentinel-before-${I$2()}`, T2 = `headlessui-focus-sentinel-after-${I$2()}`, d2 = reactExports.useRef(null), i2 = y$1(d2, l2, (u2) => {
    a2({ type: 4, panel: u2 });
  }), p$12 = n(d2);
  ...
  }, [t2.popoverState, o$12.unmount, o$12.static, a2]), reactExports.useEffect(() => {
  ...
  let x2 = reactExports.useMemo(() => ({ open: t2.popoverState === 0, close: v2 }), [t2, v2]), O$12 = { ref: i2, id: R2, onKeyDown: y2, onBlur: C$12 && t2.popoverState === 0 ? (u2) => {
    var E2, c2, B2, e2, n2;
  ...
  return d$4.createElement(Z.Provider, { value: R2 }, S2 && f2 && d$4.createElement(c$2, { id: F2, ref: t2.beforePanelSentinel, features: p.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: j2 }), X({ ourProps: O$12, theirProps: r2, slot: x2, defaultTag: we, features: Ne$1, visible: S2, name: "Popover.Panel" }), S2 && f2 && d$4.createElement(c$2, { id: T2, ref: t2.afterPanelSentinel, features: p.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: M$12 }));
}
let Ke = "div";
function We(o3, l2) {
  let s2 = reactExports.useRef(null), R2 = y$1(s2, l2), [C2, r2] = reactExports.useState([]), t2 = o$2((p2) => {
    r2((P2) => {
  ...
  }), F2 = reactExports.useMemo(() => ({ registerPopover: a2, unregisterPopover: t2, isFocusWithinPopoverGroup: v2, closeOthers: f2 }), [a2, t2, v2, f2]), T2 = reactExports.useMemo(() => ({}), []), d2 = o3, i2 = { ref: R2 };
  return d$4.createElement(se.Provider, { value: F2 }, X({ ourProps: i2, theirProps: d2, slot: T2, defaultTag: Ke, name: "Popover.Group" }));
}
let je = D$1(De$1), Ve = D$1(He$1), $e = D$1(ke), Je = D$1(Ue), Xe = D$1(We), Lt = Object.assign(je, { Button: Ve, Overlay: $e, Panel: Je, Group: Xe });
function c(a2 = 0) {
  let [l2, r2] = reactExports.useState(a2), t2 = f(), o3 = reactExports.useCallback((e2) => {
...
function ne(n2, t2) {
  let r2 = s$4(n2), o3 = reactExports.useRef([]), y2 = f(), N2 = p$1(), p2 = o$2((s2, e2 = j.Hidden) => {
...
function ye(n2, t2) {
  let { beforeEnter: r2, afterEnter: o3, beforeLeave: y2, afterLeave: N2, enter: p2, enterFrom: x2, enterTo: m2, entered: c$22, leave: u2, leaveFrom: h2, leaveTo: v2, ...s2 } = n2, e$12 = reactExports.useRef(null), a2 = y$1(e$12, t2), i2 = s2.unmount ? j.Unmount : j.Hidden, { show: l2, appear: T2, initial: se2 } = Ee(), [g2, M2] = reactExports.useState(l2 ? "visible" : "hidden"), z2 = be(), { register: F2, unregister: L2 } = z2, U2 = reactExports.useRef(null);
  reactExports.useEffect(() => F2(e$12), [F2, e$12]), reactExports.useEffect(() => {
  ...
  let B2 = s2, Te = { ref: a2 };
  return T2 && l2 && (B2 = { ...B2, className: e(s2.className, ...j$1.current.enter, ...j$1.current.enterFrom) }), d$4.createElement(I.Provider, { value: O2 }, d$4.createElement(c$1, { value: u$1(g2, { ["visible"]: d$1.Open, ["hidden"]: d$1.Closed }) | H2.flags }, X({ ourProps: Te, theirProps: B2, defaultTag: Re, features: ie, visible: g2 === "visible", name: "Transition.Child" })));
}
function Ne(n2, t2) {
  let { show: r2, appear: o3 = false, unmount: y2, ...N2 } = n2, p2 = reactExports.useRef(null), x2 = y$1(p2, t2);
  l$1();
  let m2 = C();
  ...
  let i2 = { unmount: y2 };
  return d$4.createElement(I.Provider, { value: h2 }, d$4.createElement(A.Provider, { value: a2 }, X({ ourProps: { ...i2, as: reactExports.Fragment, children: d$4.createElement(oe, { ref: x2, ...i2, ...N2 }) }, theirProps: {}, defaultTag: reactExports.Fragment, features: ie, visible: c2 === "visible", name: "Transition" })));
}
function He(n2, t2) {
  let r2 = reactExports.useContext(A) !== null, o3 = C() !== null;
  return d$4.createElement(d$4.Fragment, null, !r2 && o3 ? d$4.createElement(q, { ref: t2, ...n2 }) : d$4.createElement(oe, { ref: t2, ...n2 }));
}
